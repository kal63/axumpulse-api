...
CREATE TABLE `UserAchievements` (
  ...
  CONSTRAINT `userachievements_ibfk_63` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userachievements_ibfk_64` FOREIGN KEY (`achievementId`) REFERENCES `Achievements` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `UserChallengeProgress` (
  ...
  CONSTRAINT `userchallengeprogress_ibfk_217` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userchallengeprogress_ibfk_218` FOREIGN KEY (`challengeId`) REFERENCES `Challenges` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `UserContentProgress` (
  ...
  CONSTRAINT `usercontentprogress_ibfk_217` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `usercontentprogress_ibfk_218` FOREIGN KEY (`contentId`) REFERENCES `Contents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `UserExerciseProgress` (
  ...
  CONSTRAINT `userexerciseprogress_ibfk_325` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userexerciseprogress_ibfk_326` FOREIGN KEY (`workoutPlanId`) REFERENCES `WorkoutPlans` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `userexerciseprogress_ibfk_327` FOREIGN KEY (`exerciseId`) REFERENCES `WorkoutExercises` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `UserWorkoutPlanProgress` (
  ...
  CONSTRAINT `userworkoutplanprogress_ibfk_217` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userworkoutplanprogress_ibfk_218` FOREIGN KEY (`workoutPlanId`) REFERENCES `WorkoutPlans` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-23 19:47:27
