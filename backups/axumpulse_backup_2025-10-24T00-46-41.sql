...
CREATE TABLE `Trainers` (
  ...
  CONSTRAINT `trainers_ibfk_408` FOREIGN KEY (`applicationId`) REFERENCES `TrainerApplications` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `trainers_ibfk_409` FOREIGN KEY (`verifiedBy`) REFERENCES `Users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `UserWorkoutPlanProgress` (
  ...
  CONSTRAINT `userworkoutplanprogress_ibfk_215` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userworkoutplanprogress_ibfk_216` FOREIGN KEY (`workoutPlanId`) REFERENCES `WorkoutPlans` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-23 19:46:42
